...
parameters=(\
    ...
    2 `# spatial dimensions of simulation space`\
    ...
    800 `# number of lattice points in x-direction`\
    800 `# number of lattice points in y-direction`\
    0 `# number of lattice points in z-direction`\
    2 `# patches in x-direction`\
    2 `# patches in y-direction`\
    0 `# patches in z-direction`\
    3 `# linear vacuum (0), four-photon (1), six-photon (2), or 4- and 6-photon (3) processes`\
    40e-6 `# simulation time in meters`\
    40 `# number of simulation steps performed by CVode`\
    20 `# output step multiples`\
    ...
    `# ---- Parameters for 1D Gaussian pulses (not usable in 2D) -----`\
    ...
    0 `# amplitude of 1D Gaussian 1 in z-direction`\
    ...
    0 `# amplitude of 1D Gaussian 2 in z-direction`\
